...
### Definition of a Unique Vulnerability
To prevent trivial bypasses, a vulnerability is considered a duplicate if it shares:
1. **The Root Cause**: The underlying logic error (e.g., the specific lack of an access check).
