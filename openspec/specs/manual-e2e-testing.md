...
2. Check Redis auth credentials in `.env`:
   ...
   REDIS_URL=redis://:redis_dev_2024@localhost:6379
   ```
3. Verify auth string is correct: `redis-cli -a redis_dev_2024 ping` (should return PONG)
...
2. Verify contract is deployed on Base Sepolia:
   ```bash
   cast code 0x59932bDf3056D88DC07cb320263419B8ec1e942d --rpc-url $BASE_SEPOLIA_RPC_URL
   ```
