...
// Use env vars for wallet addresses, with zero-address fallbacks for local dev
const RESEARCHER_WALLET = process.env.RESEARCHER_WALLET_ADDRESS || '0x0000000000000000000000000000000000000000';
const VALIDATOR_WALLET = process.env.VALIDATOR_WALLET_ADDRESS || '0x0000000000000000000000000000000000000000';
...
async function main() {
  ...
  // =============================================
  // Phase D: X.402 Payment Records (skipped — real payments only)
  // =============================================
  console.log('\n4. X.402 payment records: skipped (real payments only)');
  ...
  // =============================================
  // Phase H: New Payment Types (WS3) — skipped, real payments only
  // =============================================
  console.log('\n8. New payment type records: skipped (real payments only)');
  ...
  console.log(`X.402 payments: 0 (real payments only)`);
