...
export class PlatformEscrowClient {
  ...
  async depositEscrowFor(
    ...
    console.log('[PlatformEscrow] Depositing escrow on-chain...');
    ...
    if (allowance < amount) {
      console.log('[PlatformEscrow] Approving USDC spend...');
    ...
    console.log(`[PlatformEscrow] Deposit complete: tx=${tx.hash}`);
  ...
  async deductSubmissionFee(
    ...
    console.log('[PlatformEscrow] Deducting submission fee on-chain...');
