...
export class ValidationRegistryClient {
  ...
  async recordValidation(
    ...
    try {
      console.log('[ValidationRegistry] Recording validation...');
      ...
      console.log(`[ValidationRegistry] Transaction sent: ${tx.hash}`);
      ...
      console.log(`[ValidationRegistry] Validation recorded successfully!`);
