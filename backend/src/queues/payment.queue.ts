...
const log = createLogger('PaymentQueue');
...
export async function addPaymentJob(data: PaymentJobData): Promise<void> {
  ...
  log.info(`Added payment job ${data.paymentId} to queue for validation ${data.validationId}`);
}
...
export async function pauseQueue(): Promise<void> {
  ...
  log.info('Payment processing queue paused');
}
...
export async function resumeQueue(): Promise<void> {
  ...
  log.info('Payment processing queue resumed');
}
...
export async function closePaymentQueue(): Promise<void> {
  ...
  log.info('Payment processing queue closed');
}
