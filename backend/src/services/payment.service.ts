...
export async function createPaymentFromValidation(
  ...
  try {
    ...
    console.error('[PaymentService] Error creating payment from validation:', error);
    throw error;
  }
}
...
async function formatPaymentWithDetails(
  ...
  if (validationId) {
    try {
      ...
      console.error('[PaymentService] Error fetching validation:', error);
...
export async function getUsdcAllowance(
  ...
  try {
    ...
    console.error('[PaymentService] Error getting USDC allowance:', error);
    return {
      success: false,
      error: {
...
export async function getUsdcBalance(address: string): Promise<UsdcBalanceResult> {
  try {
    ...
    console.error('[PaymentService] Error getting USDC balance:', error);
    return {
      success: false,
      error: {
...
export async function generateApprovalTransaction(
  ...
  try {
    ...
    console.error('[PaymentService] Error generating approval transaction:', error);
...
export async function getPaymentList(
  ...
  try {
    ...
    console.error('[PaymentService] Error fetching payment list:', error);
    return {
      success: false,
      error: {
...
export async function getResearcherEarnings(
  ...
  try {
    ...
    console.error('[PaymentService] Error fetching researcher earnings:', error);
    return {
      success: false,
      error: {
...
export async function getEarningsLeaderboard(
  ...
  try {
    ...
    console.error('[PaymentService] Error fetching leaderboard:', error);
    return {
      success: false,
      error: {
...
export async function getPoolStatus(protocolId: string): Promise<PoolStatusResult> {
  try {
    ...
    try {
      ...
      console.warn('[PaymentService] Failed to get on-chain balance:', error.message);
      availableBalance = protocol.availableBounty.toString();
      availableBalanceFormatted = protocol.availableBounty.toString();
    }
    ...
    console.error('[PaymentService] Error fetching pool status:', error);
    return {
      success: false,
      error: {
