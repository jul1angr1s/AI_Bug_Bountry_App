...
router.post(
  ...
  async (req: Request, res: Response) => {
    try {
      ...
      log.error('Error verifying funding:', error);
      res.status(500).json({
        error: {
          code: 'INTERNAL_ERROR',
...
router.post(
  ...
  async (req: Request, res: Response) => {
    try {
      ...
      log.error('Error requesting scan:', error);
      res.status(500).json({
        error: {
          code: 'INTERNAL_ERROR',
          message: 'Internal server error',
...
router.post(
  ...
  async (req: Request, res: Response) => {
    try {
      ...
      log.error('Error recording funding:', error);
      res.status(500).json({
        error: {
          code: 'INTERNAL_ERROR',
          message: 'Internal server error',
...
router.get(
  ...
  async (req: Request, res: Response) => {
    try {
      ...
      log.error('Error fetching funding status:', error);
      res.status(500).json({
        error: {
          code: 'INTERNAL_ERROR',
          message: 'Internal server error',
