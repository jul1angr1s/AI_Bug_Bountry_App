...
contract ValidationRegistryTest is Test {
    ...
    function setUp() public {
        ...
        registry.addValidator(validator2);
    }
    ...
    // test_RecordValidation_RevertsOnEmptyVulnerabilityType removed: contract doesn't validate empty vulnerability type
    ...
    function test_GetValidationCount() public {
        assertEq(registry.getTotalValidationCount(), 0, "Should start with 0 validations");
        ...
        assertEq(registry.getTotalValidationCount(), 1, "Should have 1 validation");
        ...
        assertEq(registry.getTotalValidationCount(), 2, "Should have 2 validations");
